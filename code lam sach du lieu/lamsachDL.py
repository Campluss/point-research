...
#write header to csv
with open("clearDT.csv", encoding ='utf8',mode="w", newline ='') as file_csv:
	header = ["sbd", "tên","dd", "mm", "yy", "toán", "ngữ văn", "khxh", "khtn", "lịch sử", "địa lí", "gdcd", "sinh học", "vật lý", "hóa học", "tiếng anh"]
...
for data in datas:
	...
	with open("clearDT.csv", "a", encoding ='utf8', newline ='') as file_csv:
		writer = csv.writer(file_csv)
		writer.writerow(data)		
	#ghi file da lam sach
	# file = open("raw_data1.txt" ,encoding = "utf8", mode="a")
	# for i in range(len(data)):
	# 	file.write(data[i] + ",")
	# file.write("\n")